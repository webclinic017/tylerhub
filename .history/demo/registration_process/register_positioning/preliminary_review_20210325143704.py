...
class review_actions(Commonweb):
    ...
    def get_success_text(self):
        self.path_data=os.path.dirname(os.path.dirname(os.path.abspath(__file__)))+r'\text_excel_data\account_number.xlsx'
        try:
            #获取文本
            self.display_get_text('css,div.ivu-dropdown-rel>button.ivu-btn-default>span>span')
        except Exception as msg:
