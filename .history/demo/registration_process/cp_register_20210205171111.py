...
class register_cp(unittest.TestCase):
    ...
    def __init__(self,methodName='runTest'):
        super(register_cp,self).__init__(methodName) #重写父类的init方法
        self.driver=form.browsertype()
    ...
    #     #     print(123)
    def test_demo(self):
        form.geturl('https://www.cnblogs.com/yoyoketang/p/9390073.html')

    def test_demo2(self):
        form.geturl('https://www.baidu.com/')
