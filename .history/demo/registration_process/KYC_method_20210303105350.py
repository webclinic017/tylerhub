...
class kyc_approve(Commonweb):
    ...
    def choose_data_gender(self):
        ...
        time.sleep(1)
        self.web_click('css,table>tbody>tr>td.available',pub_method.random_int(31,40))
        time.sleep(1)
        self.web_click('css,table.el-month-table>tbody>tr>td',pub_method.random_int(0,11))
