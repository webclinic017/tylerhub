...
path_regpro=os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
path_met=path_regpro+r'\register_positioning'
sys.path.append(path_met)
# path_regpro=path_demo+r'\'
...
if __name__=='__main__':
    #测试报告
    suit=unittest.defaultTestLoader.discover(r'E:\tyler96qa\tylerhub\demo\registration_process',
    pattern='cp_register.py',top_level_dir=None)
    BeautifulReport(suit).report(filename='会员中心注册',description='注册流程',
    report_dir=r'E:\tyler96qa\tylerhub\demo\registration_process\cp_register_process_report')