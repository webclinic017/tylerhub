...
class review_actions(Commonweb):
    ...
    def ibtype(self):
        try:
            ...
            time.sleep(3)
            #双击代理代码
            self.display_doubleclick('xpath,//div[@class="form ivu-col ivu-col-span-12"]//div[4]//i[@class="ivu-icon ivu-icon-ios-alert"]')
            # if self.is_element_isdisplayed('css,div.input-item-page-enabled>div>div'):
            #     print('111111')
            #     self.doubleclick('css,div.input-item-page-enabled>div>div')
            # else:
            #     print(22222)
