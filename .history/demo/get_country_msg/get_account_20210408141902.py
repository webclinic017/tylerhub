        ...
        try:
            ...
            while self.page<3:
                ...
                for i in range(1,self.list_len+1):
                    ...
                    if self.page==0:
                        exdata.saveainfo(os.path.dirname(os.path.abspath(__file__))+r'\all_country.xlsx',self.CN_country,'A',i+1) #保存中文国家名
                        exdata.saveainfo(os.path.dirname(os.path.abspath(__file__))+r'\all_country.xlsx',self.EN_country,'B',i+1) #保存英文国家名
                        ...
                        exdata.saveainfo(os.path.dirname(os.path.abspath(__file__))+r'\all_country.xlsx',self.CN_country,'A',i+101) 
                        exdata.saveainfo(os.path.dirname(os.path.abspath(__file__))+r'\all_country.xlsx',self.EN_country,'B',i+101) 
                        exdata.saveainfo(os.path.dirname(os.path.abspath(__file__))+r'\all_country.xlsx',self.ISO_name,'C',i+101)   
                        exdata.saveainfo(os.path.dirname(os.path.abspath(__file__))+r'\all_country.xlsx',self.PHONE_code,'D',i+101)
                    else:
                        exdata.saveainfo(os.path.dirname(os.path.abspath(__file__))+r'\all_country.xlsx',self.CN_country,'A',i+201)
                        exdata.saveainfo(os.path.dirname(os.path.abspath(__file__))+r'\all_country.xlsx',self.EN_country,'B',i+201)
                        exdata.saveainfo(os.path.dirname(os.path.abspath(__file__))+r'\all_country.xlsx',self.ISO_name,'C',i+201)
                        exdata.saveainfo(os.path.dirname(os.path.abspath(__file__))+r'\all_country.xlsx',self.PHONE_code,'D',i+201)
