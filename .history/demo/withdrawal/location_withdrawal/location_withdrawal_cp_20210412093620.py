                ...
                if common.get_lenofelement('css,div.bankItem>div.info')>1:#存在多个取款方式
                    for i in range(0,common.get_lenofelement('css,div.bankItem>div.info')):
                        if common.display_get_text('css,span.status',i) in ('审核通过','Approved'):
                            if common.is_element_selected('css,.bankInfo > div .ivu-switch',i):#会员中心按钮开启
            ...
            if common.ele_is_displayed('css,div.bankItem>div.info',2): #存在出金渠道
                ...
                if self.local_len>=3:
                    for i in range(0,self.local_len):
                        print(common.is_element_selected('xpath,//*[@id="paymentMethod"]/div[2]/div/div/div[1]/div[2]/div/div/div/span/span[2]',i))
                        while common.is_element_selected('xpath,//*[@id="paymentMethod"]/div[2]/div/div/div[1]/div[2]/div/div/div/span/span[2]',i):
                            print('被选中')
