...
class locations_of_deposit():
    ...
    def deposit(self,traccount,username,psword):
        #判断入金账号是否满足入金权限,如不满足，更改为满足
        self.is_traccount_can_deposit(traccount)
        time.sleep(1)
        #登录会员中心
...
div.card-for-loop>div>div.el-card__body>div>p>span
