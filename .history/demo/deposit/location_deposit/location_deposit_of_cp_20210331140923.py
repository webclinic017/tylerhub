...
class locations_of_deposit():
    ...
    def tdaccount_status(self,account):
        try:
            ...
            if self.account_status in ('停用','Closed'):
                ...
                print('交易账号{}状态为:{}'.format(account,self.account_status))
        except Exception as msg:
    ...
    def deposti_is_selected(self):
        try:
            ...
            #判断入金按钮是否被勾选
            time.sleep(1)
            print(common.is_element_selected('xpath,//*[@id="tdAccount"]/div[2]/div/div/div[3]/div[1]/div[2]/table/tbody/tr[4]/td[6]/div/div/div/label/span/input'))
        except Exception as msg:
