...
class locations_of_deposit():
    ...
    def get_traccount_balance(self,traccount):
        try:
            ...
            time.sleep(1)
            self.balance=common.get_text('css,div.card-for-loop>div>div.el-card__body>div>p>span',4*self.cprows-4)
            print(self.balance)
            return self.balance
        except Exception as msg:
    ...
    def deposit_cp(self,traccount,username,psword,amount):
        #登录会员中心
