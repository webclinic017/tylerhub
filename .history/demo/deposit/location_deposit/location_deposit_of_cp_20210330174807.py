...
class locations_of_deposit():
    ...
    def is_tdaccount_can_deposit(self,account):
        try:
            ...
            #判断交易账号状态
            if common.get_text('xpath,//*[@id="tdAccount"]/div[2]/div/div/div[3]/div[1]/div[2]/table/tbody/tr[{}]/td[5]/div/div/span'.format(self.rows)):
    ...
    def status_and_deposit_is_selected(self,account):
        print(5656454564)
        #获取交易账号列表的总行数
        self.tdaccount_list_len=common.get_lenofelement('xpath,//*[@id="tdAccount"]/div[2]/div/div/div[3]/div[1]/div[2]/'
        'table/tbody/tr/td[1]/div/div/span')
        time.sleep(1)
        for i in range(0,self.tdaccount_list_len):
            if str(common.get_text('xpath,//*[@id="tdAccount"]/div[2]/div/div/div[3]/'
            'div[1]/div[2]/table/tbody/tr/td[1]/div/div/span',i))==str(account):
                return i+1
                break
