...
if __name__=='__main__':
    ...
    pytest.main(['-v','-s','--alluredir',r'{}\transfer_report_other_one'.format(path_transfer),'--disable-pytest-warnings'])
    os.system(r'allure generate {}\transfer_report_other_one\ -o {}\transfer_report_other_one\ --clean'.format(path_transfer,path_transfer))
