...
if __name__=='__main__':
    ...
    pytest.main(['-s',r'{}\transfer_bin\test_transfer_action_other_one_bin.py'.format(path_transfer),'--alluredir','./temp','--disable-pytest-warnings'])
    os.system(r'allure generate ./temp -o {}\transfer_report_other_one\new_report --clean'.format(path_transfer))
