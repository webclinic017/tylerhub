...
if __name__=='__main__':
    ...
    pytest.main(['-v','-s',r'{}\transfer_bin\test_transfer_action_other_one_bin.py',
    r'--alluredir={}\transfer_report_other_one\report_data'.format(path_transfer,path_transfer),'--disable-pytest-warnings'])
