...
if __name__=='__main__':
    ...
    #pytest.main(['-v','-s','--alluredir',r'{}\transfer_report'.format(path_transfer),'--disable-pytest-warnings'])
    pytest.main([r'--allure generate {}\transfer_bin\test_transfer_action_other_one_bin.py -o {}\transfer_report --clean'.format(path_transfer,path_transfer)])
