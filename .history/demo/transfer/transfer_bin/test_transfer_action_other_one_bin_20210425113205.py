...
class Test_transfer_other_account():
    ...
    @pytest.mark.parametrize('account_from','account_to','tdaccount_from','tdaccount_to',testdata[0])
    def test_transfer(self,account_from,account_to,tdaccount_from,tdaccount_to):
        #判断转出主账户是否为返佣账号
        # if transfer.is_account_satisfy_logic(1000003759,67200977,1000004233,67201154):
        #     pytest.skip()
        # else:
        #     print('ib继续用例')
        print(account_from,account_to,tdaccount_from,tdaccount_to)
