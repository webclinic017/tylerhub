...
if __name__=='__main__':
    ...
    pytest.main([r'{}\transfer_bin\test_transfer_action_other_one_bin.py'.format(path_transfer),'-v','-s',r'--alluredir={}\transfer_report_other_one\report_data'.format(path_transfer),'--disable-pytest-warnings'])
