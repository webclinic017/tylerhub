...
if __name__=='__main__':
    ...
    pytest.main(['-s','--alluredir',r'{}\transfer_report_other_one\report_data'.format(path_transfer),'--disable-pytest-warnings'])
    ...
    os.system(r'allure serve {}\transfer_report_other_one\new_report'.format(path_transfer))
