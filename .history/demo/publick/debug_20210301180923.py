...
p=public_method()
c.open_browser()
c.open_web('https://at-client-portal-sit.atfxdev.com/login')
time.sleep(1)
c.web_click('css,.blk-sure-btn')
time.sleep(1)
c.web_input('css,.el-input__inner','tyler.tang@newtype.io',1)
time.sleep(1)
c.web_input('css,.el-input__inner','Tl123456',3)
time.sleep(1)
c.web_click('css,.login-btn')
time.sleep(1)
print(c.get_text('css,.user-name-font'))
print(p.extract_numbers(c.get_text('css,.user-name-font')))
c.web_click('partia llink,1000005308')