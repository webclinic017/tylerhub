...
randomdata.py | 生成随机数据，提取指定格式字符串等
...
*变量*:
    ...
    n：下标
***
***[randomdata.py:](https://github.com/Tyler96-QA/tylerhub/blob/main/demo/public/randomdata.py)***
 ...
 *公共方法*
    ...
    my_logger(name=conFig.get_value('log','name')) 输出日志到控制台及日志文件中,只有高于WARN级别的日志才会输出到日志文件中，其他级别日志仅输出到控制台
